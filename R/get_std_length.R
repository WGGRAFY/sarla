#' get_std_length
#' This function will process a dataset and return the mean, standard deviation, and count of length observations between the reference period spanning \code{minref} - \code{maxref}
#'
